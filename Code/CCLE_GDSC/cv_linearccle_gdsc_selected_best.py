...
for counter in range(len(list_of_CCLE_files)):
    ...
    for train_index, test_index in kf.split(ccle_x,ccle_y):
        ...
        print("-----------------------------------------------------------------------")
    selected_best_mae.append(maes_sb_gdsc)
    selected_best_mse.append(mses_sb_gdsc)
    selected_best_r2.append(r2s_sb_gdsc)
with open("results/selected_best.txt", "a") as output:
    output.write("selected_best_mae="+str(selected_best_mae)+"\n")
    output.write("selected_best_mse="+str(selected_best_mse)+"\n")
    output.write("selected_best_r2="+str(selected_best_r2)+"\n")
