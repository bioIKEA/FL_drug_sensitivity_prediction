...
for counter in range(len(list_of_CCLE_files)):
    ...
    model_average_mae.append(maes_ma)
    model_average_mse.append(mses_ma)
    model_average_r2.append(r2s_ma)
with open("results/model_average.txt", "a") as output:
    output.write("model_average_mae="+str(model_average_mae)+"\n")
    output.write("model_average_mse="+str(model_average_mse)+"\n")
    output.write("model_average_r2="+str(model_average_r2)+"\n")
