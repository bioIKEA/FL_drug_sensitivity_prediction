...
with open("results/combined_dataset.txt", "a") as output:
    output.write("gdsc_gcsi_combined_dataset_mae="+str(maes_cd)+"\n")
    output.write("gdsc_gcsi_combined_dataset_mse="+str(mses_cd)+"\n")
    output.write("gdsc_gcsi_combined_dataset_r2="+str(r2s_cd)+"\n")
