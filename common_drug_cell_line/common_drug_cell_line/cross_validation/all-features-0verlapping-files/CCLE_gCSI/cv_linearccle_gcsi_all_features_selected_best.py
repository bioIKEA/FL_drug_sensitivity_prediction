...
with open("../results/selected_best.txt", "a") as output:
    output.write("ccle_gcsi_selected_best_mae="+str(maes_sb_ccle)+"\n")
    output.write("ccle_gcsi_selected_best_mse="+str(mses_sb_ccle)+"\n")
    output.write("ccle_gcsi_selected_best_r2="+str(r2s_sb_ccle)+"\n")
