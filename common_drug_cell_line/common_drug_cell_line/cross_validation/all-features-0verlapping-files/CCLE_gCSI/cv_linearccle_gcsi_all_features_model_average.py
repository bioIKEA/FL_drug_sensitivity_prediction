...
with open("../results/model_average.txt", "a") as output:
    output.write("ccle_gcsi_model_average_mae="+str(maes_ma)+"\n")
    output.write("ccle_gcsi_model_average_mse="+str(mses_ma)+"\n")
    output.write("ccle_gcsi_model_average_r2="+str(r2s_ma)+"\n")
