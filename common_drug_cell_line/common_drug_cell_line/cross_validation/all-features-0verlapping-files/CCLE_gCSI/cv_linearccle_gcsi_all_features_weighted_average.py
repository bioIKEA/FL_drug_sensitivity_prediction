...
with open("../results/weighted_average.txt", "a") as output:
    output.write("ccle_gcsi_weighted_average_mae="+str(maes_wa)+"\n")
    output.write("ccle_gcsi_weighted_average_mse="+str(mses_wa)+"\n")
    output.write("ccle_gcsi_weighted_average_r2="+str(r2s_wa)+"\n")
