...
CCLE=pd.read_csv(data_path+'CCLE_paired_common_with_gdsc_100.csv', index_col=0)
GDSC=pd.read_csv(data_path+'GDSC_paired_common_with_ccle_100.csv', index_col=0)
