...
with open("results/ridge.txt", "a") as output:
    output.write("ccle_gcsi_our_method_mae_ridge="+str(maes_our)+"\n")
    output.write("ccle_gcsi_our_method_mse_ridge="+str(mses_our)+"\n")
    output.write("ccle_gcsi_our_method_r2_ridge="+str(r2s_our)+"\n")
