...
with open("results/ccle_gdsc_rf.txt", "a") as output:
    output.write("ccle_gdsc_our_method_mae_rf="+str(maes_our)+"\n")
    output.write("ccle_gdsc_our_method_mse_rf="+str(mses_our)+"\n")
    output.write("ccle_gdsc_our_method_r2_rf="+str(r2s_our)+"\n")
